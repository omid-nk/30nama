...
function Header() {
  return (
    <section className="fixed z-50 flex gap-2 p-4">
      <motion.span
        ...
        whileTap={{ scale: 0.96 }}
        className="bg-dark-100 hover:border-primary flex h-14 w-14 cursor-pointer items-center justify-center rounded-3xl border transition-colors"
      >
